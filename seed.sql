...
INSERT INTO public.packages (id, attr_path, name, version, description, source_url, build_phase, install_phase, unpack_phase, source_hash) VALUES (2, 'stdenv', 'stdenv', '1.0', 'Standard build environment', NULL, NULL, NULL, NULL, NULL);
